...
public class FireBall extends Sprite {
    ...
    public FireBall(PlayScreen screen, float x, float y, boolean fireRight){
        ...
        setBounds(x, y, 6 / brentMario.PPM, 6 / brentMario.PPM);
        defineFireBall();
    }

    public void defineFireBall(){
        BodyDef bdef = new BodyDef();
        bdef.position.set(fireRight ? getX() + 12 /brentMario.PPM : getX() - 12 /brentMario.PPM, getY());
        ...
        shape.setRadius(3 / brentMario.PPM);
        fdef.filter.categoryBits = brentMario.FIREBALL_BIT;
